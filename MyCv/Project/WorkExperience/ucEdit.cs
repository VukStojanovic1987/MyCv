...
namespace MyCv.Project.WorkExperience
{
    public partial class ucEdit : UserControl
    {
        ...
        private void lblYes_Click(object sender, EventArgs e)
        {
            ...
            CardNumber.Set(Library.clsFormsAndUserControls.UcWorkExperienceView.PanContent, 
                           Strings.Set("Work Experience N°", "Радно искуство БР", "Radno iskustvo BR"));
        }
        ...
        private void txtPosition_TextChanged(object sender, EventArgs e)
        {
            ...
            SaveStringData("Position", Position);
        }
        ...
        private void txtDescription_TextChanged(object sender, EventArgs e)
        {
            ...
            SaveStringData("Description", Description);
        }
        ...
        private void SetControlsText()
        {
            ...
            lblPosition.Text = Strings.Set("Position:", "", "");
            lblAttended.Text = Strings.Set("Attended:", "", "");
            lblDescription.Text = Strings.Set("Description:", "", "");
